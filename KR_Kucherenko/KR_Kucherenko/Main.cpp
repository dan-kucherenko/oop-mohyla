...
{
	{
		...
		cout << "Convert to list: " << endl;
		cout << endl;
		cities.convertToList(true); // converting to cyclic list
		cout << "Double cyclic list: " << endl << cities << endl;

		cout << endl;
		cities.convertToList(false); // converting to double single list
		cout << "Double single list" << endl << cities << endl;
		cout << "-------------------------------------------------" << endl;
	}
	 {
